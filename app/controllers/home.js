(function () {
    ...
    angular
    .module('rocapp')
    .controller('homeController', ['$scope', '$http', '$log', '$roconfig', '$cookieStore', 'managecookies', '$state', '$roconstants', '$commonsvc', '$timeout', '$rootScope',
       function ($scope, $http, $log, $roconfig, $cookie, $managecookies, $state, $roconstants, $commonsvc, $timeout, $rootScope) {
           ...
           //City Selection Display control
           ...
           if (angular.element('.citylist')) {
               $('.citylist li a').click(function () {
                   angular.element('.sitem').text($(this).text());
                   angular.element('.sitem').val($(this).text());
               });
           }
       }]);
})();