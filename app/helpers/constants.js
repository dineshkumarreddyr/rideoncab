(function () {
    ...
    angular.module('roc.constants', []).constant('$roconstants', {
        ...
        city: 'Please select city to proceed bookings.',
        couponsuccess: 'Successfully applied. Confirmation will be sent to your registered mobile number. Please show it to your cab driver.'
    });
})();